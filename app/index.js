...
function displayData(wetData) {
  ...
  results.innerHTML = `<div id="resultDiv">
    On the date ${wetData.daily.time}, the max temperature is ${wetData.daily.temperature_2m_max}!
    </div>`;
}
...
// ???????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????? Section Break
feather.replace();
// ! feather icon^ This makes the cloud logo in the top left that is not working
// ???????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????? Section Break
// function myFunction() {
